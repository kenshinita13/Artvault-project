...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0c10] text-white overflow-x-hidden font-sans">
      ...
      ───────────────────────────────────────────────────────── */}
      <main className="hidden lg:flex relative pt-32 pb-20 max-w-[1400px] mx-auto flex-row items-center justify-between min-h-[90vh]">

        {/* Left Content */}
        <div className="w-1/2 flex flex-col items-start text-left z-20 pr-10" style={{ paddingLeft: 'clamp(3rem, 8vw, 10rem)' }}>
          <motion.h1
